...
<node CREATED="1377278102654" FOLDED="true" ID="ID_112423418" MODIFIED="1378835205235" POSITION="right" TEXT="Backtracking">
...
<node CREATED="1377278095608" FOLDED="true" ID="ID_378441907" MODIFIED="1378836475933" POSITION="right" TEXT="Dynamic Programming">
<node CREATED="1377281949830" ID="ID_975700659" MODIFIED="1377281951550" TEXT="idea">
<node CREATED="1377281582111" FOLDED="true" ID="ID_765131214" MODIFIED="1378835210348" TEXT="mostly to find the optimal values">
...
<node CREATED="1377281561074" FOLDED="true" ID="ID_415939969" MODIFIED="1378835213029" TEXT="formulate the recurrance relation">
...
<node CREATED="1378835214002" FOLDED="true" ID="ID_1719331588" MODIFIED="1378835347993" TEXT="algorithms">
<node CREATED="1378835218777" FOLDED="true" ID="ID_1696547480" MODIFIED="1378835347524" TEXT="lis">
<node CREATED="1378835221489" ID="ID_712056408" MODIFIED="1378835290655" TEXT="L(i)=1+max(L(j) )  where j&lt;i and a[j]&lt;a[i]"/>
<node CREATED="1378835256292" ID="ID_1051862133" MODIFIED="1378835322617" TEXT="if no such j, then L(i)=1"/>
</node>
</node>
</node>
</node>
